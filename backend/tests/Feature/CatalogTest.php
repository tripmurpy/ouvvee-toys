...
class CatalogTest extends TestCase
{
    ...
    public function test_public_catalog_and_detail_render_active_products(): void
    {
        ...
        $this->get('/products')
            ...
            ->assertSee('Koleksi figure pilihan, siap dilihat dari dekat.')
            ->assertSee('Buka keranjang')
            ->assertSee('Buka detail produk untuk melihat preview 3D saat tersedia.')
            ->assertSee('Foto Test Mechanical Arm Display Figure', false)
            ->assertDontSee('Model 3D Test Mechanical Arm Display Figure', false)
            ->assertDontSee('environment-image="neutral"', false)
