...
- Apakah tugas kuliah/proyek mewajibkan script SQL murni atau boleh menggunakan migration Laravel.
- Apakah dashboard admin cukup read-only sesuai scope saat ini.
- Kategori mainan utama yang akan dijual pertama kali.
